                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ url('/totalOfertante ') }}">Total Ganancias Ofertantes</a></li>
...
<table class="table table-hover table-bordered results">
  <thead>
    <tr>
      ...
      <th class="col-md-3 col-xs-3">Costo</th>
      <th class="col-md-3 col-xs-3">Costo Comisión</th>
      <th class="col-md-3 col-xs-3">Titulo</th>
      <th class="col-md-3 col-xs-3">Descripción</th>
      <th class="col-md-3 col-xs-3">Direccion</th>
      <th class="col-md-3 col-xs-3">Departamento</th>
